  ...
  useEffect(() => {
    firebase.db.collection(email).onSnapshot((querySnapshot) => {
      ...
      querySnapshot.docs.forEach((doc) => {
        ...
        lista.push(<FormView name={titulo} date={date} data={data} />);
      });
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.userInfoContainer}>
        ...
        >
          ...
          >
            <Image
              source={avatar ? AvatarImg : AvatarImg2}
      ...
      <View style={styles.mainAreaContainer}>
        ...
        <View style={styles.secondRowContainer}>
          <ScrollView horizontal={true}>{listaFormularios}</ScrollView>
        </View>
        ...
        <TouchableOpacity
          style={styles.scanButton2}
          onPress={() => {
            navigation.navigate("CreateForm", { name, email, photoUrl });
          }}
        >
