...
function saveEvent(navigation,email,title,date,descripcion){
    ...
    if(title!=='' && email!=='' && descripcion!=='' && Date.parse(date)!==NaN){
        try{
              ...
              <View style={styles.container}>
                 ...
                 <View style={styles.infoContainer}>
                     <ScrollView style={styles.infoScroll}>
                        ...
                        <View style={[styles.row,{justifyContent: 'flex-start', marginLeft:32, marginTop:35}]}>
                        <Text>Descripcion: </Text>
                             
                        </View>
                        <View style={[styles.row,{justifyContent: 'flex-start', marginLeft:32}]}>
                        <TextInput style={[styles.input,{color: (buttonEnabled)? 'black':'#c9c9c9', borderBottomWidth:0, height:100,width:'80%'}]}
